...
class FoodVouchersFragment extends StatefulWidget {
  final UserMembershipDetailsModel membershipData;

  const FoodVouchersFragment({Key? key, required this.membershipData})
      : super(key: key);

  @override
  State<FoodVouchersFragment> createState() => _FoodVouchersFragmentState();
}

class _FoodVouchersFragmentState extends State<FoodVouchersFragment> {
  String userId = "";
      ...
      body: Container(
        ...
        child: StreamBuilder(
          stream: UserCouponService()
              .getFoodVoucher(widget.membershipData.id ?? "", userId),
